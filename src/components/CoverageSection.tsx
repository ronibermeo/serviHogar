...
export function CoverageSection() {
  return (
    <section id="cobertura" className="mx-auto max-w-7xl px-4 py-14 md:px-6">
      <SectionHeading
        title={`Cobertura de servicio tecnico en ${siteConfig.ciudadPrincipal} y alrededores`}
        subtitle="Si tu zona no aparece en el listado, escribenos y validamos disponibilidad en minutos."
      />
